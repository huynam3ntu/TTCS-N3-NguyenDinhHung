...
struct bigint {
    ...
    friend bigint gcd(const bigint &a, const bigint &b) { //UCLN
        return b.isZero() ? a : gcd(b, a % b);
    }
    friend bigint lcm(const bigint &a, const bigint &b) { //BCNN
        return a / gcd(a, b) * b;
    }
 	
 	//Ham chuyen doi String sang bigint
    void read(const string &s) {
 	...
 	//Nap chong toan tu nhap - xuat / cin va cout
